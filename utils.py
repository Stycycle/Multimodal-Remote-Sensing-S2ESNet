...
def sample_gt(gt, train_size, mode='random'):
    ...
    if mode == 'random':
        ...
        xs_train, ys_train = [list(t) for t in zip(*train_indices)]
        xs_test, ys_test = [list(t) for t in zip(*test_indices)]
        train_gt[xs_train, ys_train] = gt[xs_train, ys_train]
        test_gt[xs_test, ys_test] = gt[xs_test, ys_test]
    elif mode == 'fixed':
